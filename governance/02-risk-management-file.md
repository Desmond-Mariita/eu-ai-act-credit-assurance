...
| R2 | Unfaithful explanations shown to officers/applicants | **Low–Med** | High | Faithfulness benchmark + ROAR (`10`): TreeSHAP beats the floor under an **exploratory** movement metric (corroborated by ROAR); TreeSHAP the more consistent explainer | **Low–Med** (faithfulness is **metric-/sign-/regime-dependent**; a naive signed score would mislabel) | Provider |
