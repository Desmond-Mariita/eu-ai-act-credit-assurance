...
| **REC-1** | **87.4% [81.2, 91.8]** actionable loan-term **reduction** recourse; **~13% infeasible** core; reason codes duration-leaning | `12 §Recourse` | EV-013 | `python scripts/60_reason_codes.py` | Art. 86 (recourse = good practice, not a GDPR 13-15 test) |
