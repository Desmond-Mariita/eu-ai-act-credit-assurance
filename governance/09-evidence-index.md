...
content-addressed by git at tag `v1.0` (see note below). Every figure, metric, and
...
documents are content-addressed by git**: their blob SHA is frozen at tag `v1.0` — git inherently
